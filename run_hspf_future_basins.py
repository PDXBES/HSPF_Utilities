...
def main(argv):
    simulated_links_output = []
    if len(argv) > 0:
        write_obs = False
        simulated_links_output = ["AR_1", "AR_2", "AR_3", "AR_4", "AR_5", "AR_6", "AR_7", "AR_8", "AR_9", "AR_10", "AR_11", "AR_12", "AR_13", "AR_14", "FA_1", "FA_2", "FA_3", "TL_1", "TL_2", "TL_3", "TL_4", "TL_5", "TL_6", "TM_1", "TM_2", "TM_3", "TM_4", "TM_5", "TM_6", "TM_7", "TM_8", "TM_9", "TU_1", "TU_2", "TU_3", "TU_4", "TU_5", "TU_6", "TU_7"]
        simulated_links_output = ["TM_10"]
        simulated_links_output = ['AR_10',
'AR_5',
'AR_2',
'AR_0',
'FA_1',
...
#TODO need to fix this to work for lumped only or hspf/swmm only

    if post_process_swmm_statistics == "YES" or post_process_lumped_statistics == "YES":
        run_statistics = True
    else:
    ...
    if write_swmm_to_dss == "YES" or write_lumped_to_dss == "YES":
        run_obs_to_dss = True
    else:
    ...
    for rg in rgs:
        ...
        name_of_unrouted_suro_wdm_file = "HRUSURO" + ".wdm"
        name_of_unrouted_ifwo_wdm_file = "HRUIFWO" + ".wdm"
        name_of_unrouted_agwo_wdm_file = "HRUAGWO" + ".wdm"
        ...
        simulation_unrouted_suro_wdm_file_path = hspf_simulation_file_path + "\\" + name_of_unrouted_suro_wdm_file
        simulation_unrouted_ifwo_wdm_file_path = hspf_simulation_file_path + "\\" + name_of_unrouted_ifwo_wdm_file
        simulation_unrouted_agwo_wdm_file_path = hspf_simulation_file_path + "\\" + name_of_unrouted_agwo_wdm_file
        ...
        if run_hru:
            ...
            hspf_data_io.create_blank_unrouted_flow_wdm(hspf, simulation_unrouted_suro_wdm_file_path, simulation_unrouted_ifwo_wdm_file_path, simulation_unrouted_agwo_wdm_file_path)
        ...
        if run_overlay:
            ...
            progressbar = SimpleProgressBar()
            hspf.suro_wdm_file = simulation_unrouted_suro_wdm_file_path
            hspf.ifwo_wdm_file = simulation_unrouted_ifwo_wdm_file_path
            hspf.agwo_wdm_file = simulation_unrouted_agwo_wdm_file_path
        ...
        if run_post_processing or run_lumped_post_processing:
            ...
            for post in post_processing:
                ...
                for monitor_location in monitor_location_ids:
                    ...
                    temporary_flow_monitor.filtered_flow_data = temporary_flow_monitor.filtered_flow_data.loc[start_date_swmm:stop_date_swmm]
