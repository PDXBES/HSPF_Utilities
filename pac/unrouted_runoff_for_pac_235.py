...
start_date_time = "11/20/2022"
stop_date_time = "1/9/2023"
rgs = [1235]
evap_dsn = 9999
...
for area_in_sqft in areas_in_sqft:
    ...
    suro_impervious_dicts = len(suro_ifwo_predeveloped_pervious_dicts)*[{'Post': (2002, area_in_acres, 'Road Flat')}]
    for rg_dsn in rgs:
        for suro_impervious_dict, suro_ifwo_predeveloped_pervious_dict in zip(suro_impervious_dicts, suro_ifwo_predeveloped_pervious_dicts):
            ...
            sim = r"V:\PACHSPFRunoff\E10689"
            simulation_folder = sim
            output_file_name = "{}sqft_Pre_{}_Post_{}_RG{}_output".format(area_in_sqft, pre_description, post_description, rg_dsn)
            description = "Area in sq ft:" + str(area_in_sqft) + str() + " Pre:" + pre_description + " Post:" + post_description + " RG{}".format(rg_dsn)
            met_data_wdm_file_name = r"MetWestSide_Filled_adjusted.wdm"
            evap_data_wdm_file_name = r"MetWestSide_Filled_adjusted.wdm"
            ...
            output_csv_file = r"V:\PACHSPFRunoff\E10689" + "\\" + "" + output_file_name + ".txt"
