...
#                  ('2022-01-16', '2022-07-20')],  #Flow quality poor from 2021 6 21 to 2021 9 13
#                 6790: # Maple Crest
...
#                 5365: # Arnold
#                 [('2007-04-01', '2010-12-16'),
#                  ('2010-12-25 16:00', '2010-12-30 16:00'),
#                  ('2011-01-13 12:00', '2011-10-01')],
#     #South Ash
#                 10497:
...
#                  ('2020-10-10 0:00', '2020-12-07'),
#                  ('2020-12-23', '2021-02-04'),
#                  ('2021-02-28', '2021-12-07')], #bad depth sensor after 12/7/2022
#
#                 # 10519:
...
#     # DS of Woods
#     9014:
#         [('2016-11-22', '2017-06-19')],
#
#     # South Ash
#     4797:
#         [('2020-11-10', '2021-07-15 0:00')],
#
#     # Stephens
#     3641:
#         [('2020-01-10', '2020-02-09'),
#           ('2020-02-26', '2020-07-15 0:00')],
#
#
#     }
...
all_filter_dates = {
    ...
    9072:  # Looks like this location backwaters during event peaks
        [('2017-05-1', '2018-11-21'),
         ...
         ('2019-11-25', '2020-02-02'),
         ('2020-02-15', '2020-09-22'),
         ('2020-09-22', '2021-01-12 20:00'),
         ('2021-01-13 00:30', '2021-02-12'),
         ('2021-02-20', '2022-03-12')],
    ...
    10372:
        [('2018-05-01', '2019-10-16'),
         ...
         ('2020-07-01', '2020-09-01'),
         ('2020-09-11', '2021-01-02'),
         ('2021-01-12 19:00', '2021-02-12'),
         ('2021-02-20', '2021-04-30'),
         ('2021-04-30', '2022-01-16'),
         ('2022-01-16', '2022-03-12')],  # 2021-01-04 to 2021-01-11 blockage?
    ...
    10357:
        [('2009-10-01', '2018-11-09'),
         ...
         ('2020-09-05', '2020-09-22'),
         ('2020-09-22', '2021-01-20 00:00'),
         ('2021-01-22 00:00', '2021-02-12'),
         ('2021-02-20', '2022-01-16'),  # Swapped depth sensors to ultrasonic on 11/19/2021
         ('2022-01-16', '2022-03-12')],
    # Falling
    13823:  # Still waiting on 2021-10-11 data could clean up a few things in the earlier data
        [('2020-12-01', '2021-02-12'),
         ('2021-02-20', '2021-06-15'),
         ('2021-06-15', '2022-01-16'),
         ('2022-01-16', '2022-03-12')],
    ...
    10358:
        [('2007-05-01', '2018-07-06'),
         ...
         ('2021-09-17 22:00', '2022-11-15 1:00'),
         ('2022-11-15 1:25', '2022-01-16'),
         ('2022-01-16', '2022-03-12')],  # Flow quality poor from 2021 6 21 to 2021 9 13
    6790:  # Maple Crest
        [('2010-10-01', '2011-10-01')],
    ...
    5367:
        [('2007-05-29', '2019-01-12'),
         ...
         ('2020-01-07 12:00', '2020-06-19'),
         ('2020-06-19', '2020-9-2'),
         ('2020-10-15 12:00', '2021-02-12'),
         ('2021-02-20', '2021-09-14')],
    ...
    10519:
        [('2018-10-1', '2018-12-20'),
         ...
         ('2020-10-10 0:00', '2020-12-07'),
         ('2020-12-23', '2021-02-04'),
         ('2021-02-28', '2021-12-07')],  # Bad depth data after 2021-12-07
