...
all_filter_dates = {
    # Council Crest (Snow February 11-15 2021 Melt through 20th? )
                ...
                [('2021-01-26 14:00', '2021-01-30 08:00'),
                 ...
                 ("2021-12-03 00:00", '2022-03-30')], # '2021-06-15 16:00')],
    # ,'2021-10-01')],
    # Council Crest
                13837:
    ...
    # Saltzman Creek ('2010-11-17', '2012-10-12'),
                ...
                [('2010-11-17', '2012-10-12'),
                 ...
                 ('2014-02-18 12:00', '2014-3-5 18:00'),
                 ('2014-3-6 01:00', '2015-04-27')],
                 #('2014-03-06', '2015-04-27')],
    # Tryon
                9072: # Looks like this location backwaters during event peaks
                [('2017-05-1', '2018-11-21'),
                 ...
                 ('2022-01-16', '2022-03-13')], # need to review data after 2021/6/10 to understand increase in scatter
                ...
                [('2018-05-01', '2019-10-16'),
                 ...
                 ('2021-04-30', '2022-01-16'),
                 ('2022-01-16', '2022-03-13')], # 2021-01-04 to 2021-01-11 blockage? # still waiting for data after 2022 2
                ...
                [('2009-10-01', '2018-11-09'),
                 ...
                 ('2021-01-22 00:00', '2022-01-16'), # Swapped depth sensors to ultrasonic on 11/19/2021
                 ('2022-01-16', '2022-03-30')], # still waiting on data after 2/22/2022
    # Falling
                ...
                [('2020-12-01', '2021-06-15'),
                 ...
                 ('2022-01-16', '2022-03-30')], # still waiting on data after 2/8/22

                4282: # doesn't seem to have data WQ?
                [('2005-2-2', '2009-12-16')],

                10359: # blockage after  January 15 2021 event
                ...
                [('2007-05-01', '2018-07-06'),
                 ...
                 ('2022-11-15 1:25', '2022-01-16'),
                 ('2022-01-16', '2022-03-30')],  #Flow quality poor from 2021 6 21 to 2021 9 13
                6790: # Maple Crest
    ...
    #South Ash
                ...
                [('2018-10-1', '2018-12-20'),
                 ...
                 ('2021-02-28', '2022-03-30')], # Not sure why data flagged by filter routine after 1/8/2022
    ...
    # CC Sanitary
                13690:
                [('2019-11-24 23:30', '2019-11-25 3:00'),
                 ('2019-11-26 10:00', '2019-11-26 13:00'),
                 ('2019-12-06 20:30', '2019-12-07 2:30'),
                 ('2019-12-07 7:00', '2019-12-07 17:00'),
                 ('2019-12-18 20:00', '2019-12-20 00:00'),
                 ('2019-12-18 20:00', '2019-12-20 00:00'),
                 ('2019-12-20 06:00', '2019-12-23 22:00'),
                 ('2019-12-31 15:00', '2020-1-01 13:00'),
                 ('2020-01-10 18:00', '2020-01-24'),
                 ('2020-01-24', '2020-02-24')
                 ], # (2019-11-19 12:00, 2019-11-19 6:00), (2019-12-10 12:00, 2019-12-13 00:00)
                10427:
                [('2018-01-02', '2019-10-11'),
                 ('2020-09-23', '2022-02-04')],
                10426:
                [('2017-09-01', '2022-02-18'),
                 ('2022-02-21', '2022-04-14')],
    ...
    [('2019-10-01', '2022-02-01')],
                   13820:
                   [('2019-10-01', '2021-05-04 0:00'),
                   ('2021-05-08 0:00', '2022-03-30')],
                   13821:
                   [('2019-10-01', '2021-06-01')],
                   13814:
                   [('2019-10-01', '2022-03-30')],
    4771:
    [('2019-10-01', '2021-01-13 03:00'),
     ('2021-01-15', '2022-03-30')],
    13835:
    [('2019-10-01', '2021-04-25 0:00'),
     ('2021-06-04', '2022-03-30')],
            13822:
            [('2019-10-01', '2022-03-30')]
    }
...
#        temp_monitor_filtered.filtered_flow_data.to_excel(r"c:\temp\flow.xlsx")
        ...
        if temp_monitor_filtered.node_name == None:
            temp_monitor_filtered.node_name = "None"
