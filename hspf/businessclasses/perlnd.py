class Perlnd(object):
    ...
    def __init__(self, hspf, perv_cover, slope, soil, perlnd_id, rain_gage):
        self.area = 0
        ...
        self.hspf_rain_gage_id = rain_gage
        self.perlnd_id = perlnd_id
        self.perlnd_name = "PERLND_P" + "{id:04d}".format(id=self.perlnd_id)
