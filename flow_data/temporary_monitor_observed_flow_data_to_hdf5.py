...
location_ids =[ 13690, 10427, 10426]
...
for location_id in location_ids:
        ...
        if all_filter_dates[location_id] is not None:
            ...
            try:
                temp_monitor_filtered.flow_data.dropna().to_excel(output_hdf5 + "\\" + "raw" + str(location_id) + ".xlsx")
            except:
                print("raw data too large for excel")
            try:
                temp_monitor_filtered.filtered_flow_data.dropna().to_excel(output_hdf5 + "\\" + "filtered" + str(location_id) + ".xlsx")
            except:
